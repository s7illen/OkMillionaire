$(document).ready(function () {
    $(".gameTitle").hide(0).delay(0).fadeIn(3000);
    $("html").hide(0).delay(0).slideDown(3000);
});
...
let headlines = [
    ...
    {
        text: 'EU Kicked UK out of EU, a Global Recession is Happening',
        effect: function () {
            for (i = 0; i < stockMarket.length; i++) {
    ...
    {
        text: 'Amazon Rainforest is Still Burning, We are Going to Hell!',
        effect: function () {
            for (i = 0; i < stockMarket.length; i++) {
                stockMarket[i].trend -= 0.001;
            }
    ...
    {
        text: `Toyota's New Electric SUV Received 42,000 Reservations at Launch`,
        effect: function () {
            stockMarket[6].event *= 0.95;
            stockMarket[6].trend -= 0.0025;
            stockMarket[7].event *= 1.1;
...
$('.next').on('click', function () {
        ...
        if (economyTrend / stockMarket.length < 0.998){
            ...
            if (ranEvent < 72) {
                ...
                $('.news h3').append('No Breaking News This Week');
            }
        }
        ...
        for (x = 0; x < stockMarket.length; x++){
            ...
            if (stockMarket[x].updown > 0) {
                $('.stockMarket ' + 'ul ' + 'li:nth-child(' + (x + 2) + ') ' + '.change').prepend(`<i class="fas fa-angle-double-up"></i> ${Math.abs(stockMarket[x].updown)}%`);
                $('.stockMarket ' + 'ul ' + 'li:nth-child(' + (x + 2) + ') ' + '.change').css('color', 'green');
            }   
            else {  
                $('.stockMarket ' + 'ul ' + 'li:nth-child(' + (x + 2) + ') ' + '.change').prepend(`<i class="fas fa-angle-double-down"></i> ${Math.abs(stockMarket[x].updown)}%`);
                $('.stockMarket ' + 'ul ' + 'li:nth-child(' + (x + 2) + ') ' + '.change').css('color', 'red');
            }

            if (stockMarket[x].year > 0) {
                $('.stockMarket ' + 'ul ' + 'li:nth-child(' + (x + 2) + ') ' + '.yearlyChange').prepend(`<i class="fas fa-angle-double-up"></i> ${Math.abs(stockMarket[x].year)}%`);
                $('.stockMarket ' + 'ul ' + 'li:nth-child(' + (x + 2) + ') ' + '.yearlyChange').css('color', 'green');
            }
            else {
                $('.stockMarket ' + 'ul ' + 'li:nth-child(' + (x + 2) + ') ' + '.yearlyChange').prepend(`<i class="fas fa-angle-double-down"></i> ${Math.abs(stockMarket[x].year)}%`);
                $('.stockMarket ' + 'ul ' + 'li:nth-child(' + (x + 2) + ') ' + '.yearlyChange').css('color', 'red');
            }
        }
